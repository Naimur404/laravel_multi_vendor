...
Route::get('/sellers', function () {
    return redirect()->route('all_shops');
})->name('sellers');

//Route::get('/sellers/official', [HomeController::class, 'official_shops'])->name('official_shops');
//paginate don't work if it's not a builder method, causing 500 error
//check HomeController -> official_shops(), all_shops()

Route::get('/sellers/all', function (){
    $shop_names = Shop::all()->pluck('name')->toArray();
    $shops = Shop::whereIn('name', $shop_names)->paginate(15);  
    return view('frontend.shop_listing', compact('shops'));
})->name('all_shops');  

Route::get('/sellers/official', function (){
