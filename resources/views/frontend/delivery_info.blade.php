                    ...
                    <div class="card mb-3 shadow-sm border-0 rounded">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row border-top pt-3">
                                ...
                                <div class="col-md-12" style="padding: 10px; margin: 10px 0px; background-color: #EFFFFD; justify-content:center; color:#303841; font-family: Verdana, Helvetica, sans-serif;">
