...
<section class="py-5 footer-widget" style="background-color:#add8e6;color:black;">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                            ...
                            <li class="mb-2">
                                <a href="{{ route('terms') }}" class="opacity-50 hov-opacity-100 text-reset">
                                    {{ translate('Terms & conditions') }}
                                </a>
                            </li>
                            
                            <li class="mb-2">
                                <a href="{{ route('returnpolicy') }}" class="opacity-50 hov-opacity-100 text-reset">
                                    {{ translate('Return Policy') }}
                                </a>
                            </li>
                            
                            <li class="mb-2">
                                <a href="{{ route('supportpolicy') }}" class="opacity-50 hov-opacity-100 text-reset">
                                    {{ translate('Support Policy') }}
                                </a>
                            </li>
                            
                            <li class="mb-2">
                                <a href="{{ route('privacypolicy') }}" class="opacity-50 hov-opacity-100 text-reset">
                                    {{ translate('Privacy Policy') }}
                                </a>
                            </li>
                            <li class="mb-2">
                                <a href="https://osun.com.bd/cookiepolicy" class="opacity-50 hoprivacypolicy text-reset">
                                    {{ translate('Cookie Policy') }}
                                </a>
                            </li>
                            <li class="mb-2">
                                <a href="https://osun.com.bd/career" class="opacity-50 hoprivacypolicy text-reset">
                                    {{ translate('Career') }}
                                </a>
                            </li>
                    </ul>
...
<!-- FOOTER -->
<footer class="pt-3 pb-7 pb-xl-3 text-light" style="background-color: #528aae;">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-12">
                <div class="text-center" current-verison="{{get_setting("current_version")}}">
                    {!! get_setting('frontend_copyright_text',null,App::getLocale()) !!}</p>
                </div>
            </div>
            <!--<div class="col-lg-4">
    ...
    <div class="row align-items-center gutters-5">
        ...
        <div class="col">
            <a href="{{ route('cart') }}" class="text-reset d-block text-center pb-2 pt-3">
                ...
                <i class="las la-shopping-bag fs-20 opacity-60 {{areActiveRoutes(['cart'],'opacity-100 text-primary')}}"></i>
        ...
        <div class="col">
            <a href="{{ route('conversations.index') }}" class="text-reset d-block text-center pb-2 pt-3">
                <i class="las la-comment-dots"></i>
                <span class="d-block fs-10 fw-600 opacity-60 {{ areActiveRoutes(['conversations.index'],'opacity-100 fw-600')}}">{{ translate('Message') }}</span>
            </a>
        </div>
        ...
        <div class="col-auto">
            <a href="{{ route('home') }}" class="text-reset d-block text-center pb-2 pt-3">
                <span class="align-items-center bg-primary border border-white border-width-4 d-flex justify-content-center position-relative rounded-circle size-50px" style="margin-top: -33px;box-shadow: 0px -5px 10px rgb(0 0 0 / 15%);border-color: #fff !important;">
                    ...
                    <i class="las la-home la-2x text-white"></i>
                </span>
...
<div class="aiz-mobile-side-nav-cat collapse-sidebar-wrap sidebar-xl d-xl-none z-1035">
    <div class="overlay dark c-pointer overlay-fixed" data-toggle="class-toggle" data-backdrop="static" data-target=".aiz-mobile-side-nav-cat" data-same=".mobile-side-nav-thumb"></div>
    <div class="collapse-sidebar bg-white">
        @include('frontend.inc.category_side_nav')
    </div>
</div>
