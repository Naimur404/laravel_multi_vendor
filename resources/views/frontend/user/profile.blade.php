    ...
    <form action="{{ route('user.profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        @if(Auth::user()->seller)
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <label class="col-md-12 col-form-label" style="text-align:center;"><b>Mobile Financial Services (MFS)</b></label>
                </div><br/>
                <div class="row">
                    <label class="col-md-3 col-form-label">{{ translate('Bkash Account Number') }}</label>
                    <div class="col-md-9">
                        <input type="number" lang="en" class="form-control mb-3" placeholder="Bkash Account Number" value="{{ Auth::user()->seller->bkash_number }}" name="bkash_number">
                    </div>
                </div>
                <div class="row">
                    <label class="col-md-3 col-form-label">{{ translate('Nagad Account Number') }}</label>
                    <div class="col-md-9">
                        <input type="number" lang="en" class="form-control mb-3" placeholder="Nagad Account Number" value="{{ Auth::user()->seller->nagad_number }}" name="nagad_number">
                    </div>
                </div>
            </div>
            </div>
