              ...
              <div class="card-body">
                  <table class="table aiz-table mb-0">
                      ...
                      <tr>
                          ...
                          <td>{{ count(\App\Models\OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status', 'confirmed')->get()) }}</strong></td>
                      </tr>
                      <tr>
                          <td>Picked Orders:</td>
                          <td>{{ count(\App\Models\OrderDetail::where('seller_id', Auth::user()->id)->where('delivery_status', 'picked')->get()) }}</strong></td>
                      </tr>
                      <tr>
