...
<head>
    ...
    <style>
        ...
        div#fetched-menu ul li:hover ul { display: block; }
        ...
        @media only screen and (max-width: 600px) {
            ...
            #topBar ul li.cat-desktop {
                display: none;
            }
            #topBar ul li.cat-mobile {
            ...
            #showDrop:checked ~ .drop-menu-nested {
                max-height: 100%;
            }
    ...
    @if (get_setting('show_cookies_agreement') == 'on')
        <div class="aiz-cookie-alert shadow-xl">
            <div class="p-3 bg-white rounded">
                ...
                <button class="btn btn-warning aiz-cookie-accept" style="margin: 0px !important; padding: 5px !important;">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.category-nav-element').each(function(i, el) {
                ...
                $(el).on('mouseover', function() {
                    $(this).css("background", "#EEF2FF").css("border-radius", "3px");
        ...
        //category sidebar
        function handleNestedList(e){
        let listItem = e.parentNode.parentNode;
        let nestedList = listItem.getElementsByClassName("drop-menu-nested")[0];
