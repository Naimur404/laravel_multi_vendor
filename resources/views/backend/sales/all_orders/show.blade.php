...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row gutters-5">
            <div class="col text-center text-md-left" style="margin-top: 25px;">
                <div class="mb-3">
                    @php
                        $removedXML = '<?xml version="1.0" encoding="UTF-8"?>';
                    @endphp
                    {!! str_replace($removedXML,"", QrCode::size(80)->generate($order->code)) !!}
                </div>
                <div class="mb-3" style="margin-bottom: 25px;">
                    @php 
                        echo '<img src="data:image/png;base64,' . DNS1D::getBarcodePNG($order->code, 'C128',1.5,40,array(1,1,1), true) . '" alt="barcode"   />';
                    @endphp
                </div>
            </div>
            <div class="col text-center text-md-left" style="margin-top: 25px; margin-left:50px; margin-bottom:20px;">
                <address>
            ...
            <div class="col-md-4 ml-auto" style="margin-top: 25px;">
                <table>
                    <tbody>
                        <tr>
